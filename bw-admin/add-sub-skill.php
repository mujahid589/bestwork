...
//    echo "<script>alert()</script>";
    ...
    values('$name','$desc','$file_name','$slug','$sid') ");
    if($query){
        move_uploaded_file($file_tmp,"../media/skills/".$file_name);
        header('location:sub-skills.php?message=Skills added successfully&check=1');
    }else{
//        echo "error";
//        echo mysqli_error($db);
        header('location:sub-skills.php?message=Something went wrong&check=0');
    }
}
?>
