					...
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								<span class="no text-blue weight-500 font-24">0</span>
								<p class="weight-400 font-18">Total Orders  </p>
							</div>
						</div>
						<div class="project-info-progress">
							...
							<div class="progress" style="height: 10px;">
								<div class="progress-bar bg-blue progress-bar-striped progress-bar-animated" role="progressbar" style="width: 4%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								<span class="no text-light-green weight-500 font-24">0</span>
								<p class="weight-400 font-18">Customers </p>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
							...
							<div class="progress" style="height: 10px;">
								<div class="progress-bar bg-light-green progress-bar-striped progress-bar-animated" role="progressbar" style="width: 10%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								<span class="no text-light-orange weight-500 font-24">0</span>
								<p class="weight-400 font-18">Total Products</p>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
				...
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-20 box-shadow border-radius-5 margin-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								<span class="no text-light-purple weight-500 font-24">0</span>
								<p class="weight-400 font-18">Total Categories</p>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								<span class="no text-light-green weight-500 font-24">0$</span>
								<p class="weight-400 font-18">Total Earnings </p>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
								<div class="col-sm-6 text-muted weight-500">Target </div>
								<div class="col-sm-6 text-right weight-500 font-14 text-muted">200000$</div>
							</div>
							<div class="progress" style="height: 10px;">
								<div class="progress-bar bg-light-green progress-bar-striped progress-bar-animated" role="progressbar" style="width: 10%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
							</div>
