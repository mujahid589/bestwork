            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <a href="add-sub-skill.php" class="btn btn-primary">Add New Skill</a>
                ...
                <div class="row">
                    ...
                    <table class="stripe hover data-table-export nowrap">
                        ...
                        while ($row=mysqli_fetch_array($query)){
                            $parent=$row['parent'];
                            $q2=mysqli_query($db,"select * from skills where skill_id='$parent'");
                            ...
                            <tr>
                                ...
                                <td class="table-plus"><?php echo $row2['skill_name'] ?></td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="edit-sub-skill.php?skid=<?php echo $row['skill_id'] ?>"><i class="fa fa-edit"></i> Edit</a>
